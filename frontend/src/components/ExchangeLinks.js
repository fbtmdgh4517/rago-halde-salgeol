    ...
    return (
        <div className="border border-blue-200 max-w-5xl mx-auto rounded-xl shadow-md p-4 mb-9">
            ...
            <div className="grid grid-cols-6 gap-4 justify-items-center">
                ...
                <a href="https://www.bithumb.com" className="hover:bg-blue-100/60 text-center">
                    <img
                        className="w-12 h-12"
                ...
                <a href="https://coinone.co.kr/" className="hover:bg-blue-100/60 text-center">
                    <img
                        className="w-12 h-12"
                ...
                <a href="https://www.korbit.co.kr/" className="hover:bg-blue-100/60 text-center">
                    <img
                        className="w-12 h-12"
                ...
                <a href="https://www.hb.co.kr/ko-kr/" className="hover:bg-blue-100/60 text-center">
                    <img
                        className="w-12 h-12"
                ...
                <a href="https://www.binance.com/en" className="hover:bg-blue-100/60 text-center">
                    <img
                        className="w-12 h-12"
                ...
                <a href="https://ftx.com/" className="hover:bg-blue-100/60 text-center">
                    <img
                        className="w-12 h-12"
                ...
                <a href="https://www.coinbase.com/" className="hover:bg-blue-100/60 text-center">
                    <img
                        className="w-12 h-12"
                ...
                <a href="https://www.kraken.com/" className="hover:bg-blue-100/60 text-center">
                    <img
                        className="w-12 h-12"
                ...
                <a href="https://www.kucoin.com/ko" className="hover:bg-blue-100/60 text-center">
                    <img
                        className="w-12 h-12"
                ...
                <a href="https://www.bybit.com/en-US/" className="hover:bg-blue-100/60 text-center">
                    <img
                        className="w-12 h-12"
                ...
                <a href="https://www.mexc.com/ko-KR" className="hover:bg-blue-100/60 text-center">
                    <img
                        className="w-12 h-12"
